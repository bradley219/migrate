...
// import "github.com/bradley219/migrate/migrate" for usage within Go.
package main
...
import (
	...
	_ "github.com/bradley219/migrate/driver/bash"
	_ "github.com/bradley219/migrate/driver/cassandra"
	_ "github.com/bradley219/migrate/driver/crate"
	_ "github.com/bradley219/migrate/driver/mysql"
	_ "github.com/bradley219/migrate/driver/neo4j"
	_ "github.com/bradley219/migrate/driver/postgres"
	_ "github.com/bradley219/migrate/driver/ql"
	_ "github.com/bradley219/migrate/driver/sqlite3"
	"github.com/bradley219/migrate/file"
	"github.com/bradley219/migrate/migrate"
	"github.com/bradley219/migrate/migrate/direction"
	pipep "github.com/bradley219/migrate/pipe"
...
func main() {
	...
	case "goto":
		...
		toVersionUint, err := strconv.ParseUint(toVersion, 10, 64)
		if err != nil {
			fmt.Println(err)
			os.Exit(1)
		}
		...
		timerStart = time.Now()
		pipe := pipep.New()
		go migrate.GoTo(pipe, *url, *migrationsPath, toVersionUint)
		ok := writePipe(pipe)
		printTimer()
		if !ok {
			os.Exit(1)
